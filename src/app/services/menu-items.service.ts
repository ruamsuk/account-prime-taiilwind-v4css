      ...
      items: [
        {
          ...
          icon: 'pi pi-list',
          command: () => {
            this.router.navigateByUrl('/account/account-list').then();
          }
        },
        {
          label: 'ตามช่วงเวลา',
          ...
          command: () => {
            this.router.navigateByUrl('/account/between').then();
          }
        },
        {
          ...
          command: () => {
            this.router.navigateByUrl('/account/between-detail').then();
          }
        },
        {
          label: 'ตลอดทั้งปี',
          icon: 'pi pi-book',
          command: () => {
            this.router.navigateByUrl('/account/allyear').then();
          }
        },
      ],
    },
      ...
      items: [
        {
          ...
          icon: 'pi pi-list',
          command: () => {
            this.router.navigateByUrl('/credit/credit-list').then();
          }
        },
        {
          label: 'ตามช่วงเวลา',
          icon: 'pi pi-clock',
          command: () => {
            this.router.navigateByUrl('/credit/between').then();
          }
        },
        {
          label: 'ตลอดปี',
          icon: 'pi pi-book',
          command: () => {
            this.router.navigateByUrl('/credit/allyear').then();
          }
        },
      ],
    },
      ...
      items: [
        {
          ...
          icon: 'pi pi-list',
          command: () => {
            this.router.navigateByUrl('/bloods/blood-list').then();
          }
        },
        {
          label: 'Time period',
          icon: 'pi pi-calendar-clock',
          command: () => {
            this.router.navigateByUrl('/bloods/blood-time-period').then();
          }
        },
        {
          label: 'Year period',
          icon: 'pi pi-calendar-plus',
          command: () => {
            this.router.navigateByUrl('/bloods/blood-year-period').then();
          }
        },
      ],
    },
      ...
      items: [
        {
          ...
          icon: 'pi pi-book',
          command: () => {
            this.router.navigateByUrl('/monthly').then();
          }
        },
      ],
    },
      ...
      items: [
        {
          ...
          icon: 'pi pi-users',
          command: () => {
            this.router.navigateByUrl('/manage-user').then();
          }
        },
      ],
